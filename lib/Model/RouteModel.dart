...
class RouteModel {
  ...
  RouteModel({this.zone, this.vehicleId, this.assignedEmployees, this.vehicleCapacity, this.tripType, this.vendorId, this.vendorName, this.driverId, this.driverName, this.vehicleNumber, this.id});
...
class AssignedEmployees {
  ...
  AssignedEmployees({this.id, this.company, this.employee, this.date, this.shift, this.nodalPoint, this.homeLocation, this.pickupLocation, this.dropLocation, this.office, this.zone, this.tripType, this.distanceFromCompany, this.tampered, this.createdAt, this.updatedAt, this.v});
